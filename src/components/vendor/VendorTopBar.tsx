...
import { VendorMenuButton } from "@/components/vendor/VendorSidebar";
...
export function VendorTopBar({ title, subtitle, onMenuOpen }: VendorTopBarProps) {
  ...
  return (
    <header className="bg-white border-b border-border px-4 md:px-6 py-4 flex items-center justify-between gap-4 sticky top-0 z-40">
      <div className="flex items-center gap-3 min-w-0">
        <VendorMenuButton onOpen={onMenuOpen} />
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <div className="hidden sm:flex items-center gap-2">
          <div className="size-9 rounded-full bg-navy-light flex items-center justify-center text-white text-sm font-semibold">
            {initials}
          </div>
          <div>
